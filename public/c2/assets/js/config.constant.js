...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'pipelineCtrl': 'assets/js/controllers/pipelineCtrl.js',
        'contentCtrl': 'assets/js/controllers/contentCtrl.js',
		'loginCtrl': 'assets/js/controllers/loginCtrl.js',
		'loginInterceptCtrl':'assets/js/controllers/loginInterceptCtrl.js',
        'pipelineDetailsCtrl': 'assets/js/controllers/pipelineDetailsCtrl.js',
        ...
        'ngTagsInput': 'vendor/ng-tags-input/ng-tags-input.min.js',
        //*** Filters
